  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        donate: "bg-gradient-to-r from-primary to-soft-purple text-primary-foreground hover:shadow-xl transform hover:-translate-y-1 font-semibold",
        empowerment: "bg-lilac text-lilac-foreground hover:bg-lilac/90 hover:shadow-lg transform hover:-translate-y-0.5",
        soft: "bg-gentle-rose text-warm-neutral-foreground hover:bg-gentle-rose/80 border border-border/50",
      },
      size: {
